...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [413] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_fn_stmt, 6, 0, 0),
  [415] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_fn_stmt, 6, 0, 0),
  [417] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_fn_stmt, 5, 0, 0),
  [419] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_fn_stmt, 5, 0, 0),
  [421] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_fn_stmt, 7, 0, 0),
  [423] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_fn_stmt, 7, 0, 0),
  [425] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_fn_stmt, 8, 0, 0),
  [427] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_fn_stmt, 8, 0, 0),
